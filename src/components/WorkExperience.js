...
//     const isOdd = index % 2 === 1;  // Use index to determine if it's odd or even
//     return (
//       <TimelineItem key={item.jobTitle}>
//         {isOdd ? (
//           <>
...
//   return (
//     <Box display="flex" justifyContent="center" width="100%" sx={{ margin: '0 auto', padding: '20px' }}>
//       <Timeline align="alternate" data-aos="fade-up">
//         {jobs.map((job, index) => displayTimeLineItem(job, index))}
//         <TimelineItem>
//           <TimelineSeparator>
